...
/**
 * Assuming all the big urls are unquily identified by Unique ID (Integer) from database. Tiny URL contains [a-z|A-Z|0-9].
 *
...
public class TinyURLGenerator {
    /**
     * Given an integer unique ID from database, converting to tiny string using log(62) since a-z, A-Z, 0-9 combined is 62.
     */
