 ...
 * combinationLength as arguments.<br> A function next() that returns the next combination of length combinationLength
 * in lexicographical order.<br> A function hasNext() that returns True if and only if there exists a next combination.
 * <br>
 * <p>
 * Example: <br>
 * <p>
 ...
 * <p>
 * iterator.next(); // returns "ab" <br> iterator.hasNext(); // returns true <br> iterator.next(); // returns "ac" <br>
 * iterator.hasNext(); // returns true <br> iterator.next(); // returns "bc" <br> iterator.hasNext(); // returns false
 * <br>
 */
