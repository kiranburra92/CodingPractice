 ...
 * Example 1:
 * <p>
 * Input: asteroids = [5,10,-5] Output: [5,10] Explanation: The 10 and -5 collide resulting in 10.  The 5 and 10 never
 * collide. Example 2:
 * <p>
 * Input: asteroids = [8,-8] Output: [] Explanation: The 8 and -8 collide exploding each other. Example 3:
 * <p>
 * Input: asteroids = [10,2,-5] Output: [10] Explanation: The 2 and -5 collide resulting in -5. The 10 and -5 collide
 ...
 * moving right. Asteroids moving the same direction never meet, so no asteroids will meet each other.
 */
