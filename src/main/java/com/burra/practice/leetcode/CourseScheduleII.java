...
public class CourseScheduleII {
    class Solution {
         ...
         * Essentially, any node that has an in-degree of 0 can start the topologically sorted order. If there are
         * multiple such nodes, their relative order doesn't matter and they can appear in any order.
         */
