 ...
 * course ai.
 * <p>
 * For example, the pair [0, 1], indicates that to take course 0 you have to first take course 1. Return true if you can
...
public class CourseSchedule {
   ...
   * <p>
   * Now while exploring the neighbors the node if any of its neighbors color is gray it confirms the back edge in the
   * graph and proofs there is a cycle..
   */
